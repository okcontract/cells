...
test("map with undefined", async () => {
    ...
    const c = proxy.map([a, b], async (a, b) => {
        console.log({ a, b });
...
test("map with undefined with pointers in the way", async () => {
    ...
    const depOnPointerAndUndefined = proxy.mapNoPrevious([pointerToA, b], (...arr) => arr, "depOnPointerAndUndefined");
    const pointerOnDep = proxy.new(depOnPointerAndUndefined, "pointerOnDep");
    const depOnDepTrace = [];
    const depOnDep = proxy.map([depOnPointerAndUndefined], (v) => {
    ...
    depOnPointerAndUndefined.subscribe((v) => notifiedValues.depOnPointerAndUndefined.push(v));
