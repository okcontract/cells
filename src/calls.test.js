...
test("count calls", async () => {
    ...
    [pointerToA, b, anotherPointer], (...arr) => {
        console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   HEY I AM BEING CALLED (depOnPointerAndUndefined)", { arr });
        count++;
        return arr;
    ...
    const depOnDep = proxy.map([computing, pointerToB], (v) => {
        countDepOnTrace++;
        console.log("...........................................   HEY I AM BEING CALLED (depOnPointerAndUndefined)", { v });
        return v;
    }, "depOnDep");
